...
export type User = {};
export type BaseEntitySheet = {};
export type EntityCollection = Entity[];
export type Folder = {};
export type Config = {
	baseEntity: Entity | null,
	embeddedEntities: string[] | { Combatant: string; },
...
export type SortRelativeParameter = {
	target?: any;
...
export class Entity
{
	 ...
	 * @see {Entity#render}
	 */
	apps!: { [id: number]: { message: Application; }; };
	/**
	 ...
	 * @private
	 */
	private get _sheetClass(): null | any
	{
		return null;
	}
	 ...
	 */
	getUsers(permission: string | number, exact = false): User[]
	{
		return [];
	}
	 ...
	 * entity.limited;
	 */
	hasPerm(user: User, permission: string | number, exact: boolean = false)
	{
		return true;
	}
   ...
   */
	update(data: Data, options?: Options): Promise<Entity> { throw new Error(); }
	/**
	...
	*/
	delete(options?: Options): Promise<Entity> { throw new Error(); }
	/**
	 ...
	 * const temp = await actor.createEmbeddedEntity("OwnedItem", data, {temporary: true}); // Not saved to the Actor
	 */
	createEmbeddedEntity(embeddedName: string, data: Data | Data[], options?: any): Promise<Data | Data[]> { throw new Error(); }
	/**
	 ...
	 */
	updateEmbeddedEntity(embeddedName: string, data: Data | Data[], options?: Options): Promise<Entity | Entity[]> { throw new Error(); }
	/**
	 ...
	 */
	deleteEmbeddedEntity(embeddedName: string, data: string | string[], options?: Options): Promise<Data | Data[]> { throw new Error(); }
	/**
	 ...
	 */
	setFlag(scope: string, key: string, value: any): Promise<Entity> { throw new Error(); }
	/**
	 ...
	 */
	unsetFlag(scope: string, key: string): Promise<Entity> { throw new Error(); }
	/**
	 ...
	 */
	sortRelative({ target, siblings, sortKey, sortBefore, updateData }: SortRelativeParameter = {}): Promise<void> { throw new Error(); }
	/**
	 ...
	 */
	clone(createData?: {}, options?: {}): Promise<Entity> { throw new Error(); }
	/**
	 ...
	 * @return {Promise.<Entity>}   The updated Entity
	 */
	importFromJSON(json: string): Promise<Entity> { throw new Error(); }
	/**
	 * Render an import dialog for updating the data related to this Entity through an exported JSON file
	 * @return {Promise.<void>}
	 */
	importFromJSONDialog(): Promise<void> { throw new Error(); }
	/**
